...
export default function Nav() {
  ...
  return (
    <ul
      className="flex flex-col justify-center items-end fixed top-1/2 h-screen -translate-y-1/2 right-12  py-16 text-2xl font-semibold font-inter gap-5 text-gray-200/50 animate__animated animate__fadeIn

...
export default function SocialBar({ vertical = false,  className="" }) {
  let styling;
  if (vertical)
    styling = `flex flex-col justify-center fixed top-1/2 h-screen -translate-y-1/2 left-6  py-16 text-2xl gap-5 text-gray-200/50 animate__animated animate__fadeIn
  ...
  else styling = `flex justify-center pt-4 text-2xl gap-5 text-gray-200/50 animate__animated animate__fadeIn`;
